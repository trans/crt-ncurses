...
check:
  crystal build --no-codegen src/crt.cr

# Build the binary
build:
  crystal build src/cli.cr -o bin/crt

# Build release binary
release:
  crystal build --release src/cli.cr -o bin/crt
...
clean:
  rm -rf docs/api lib .crystal .shards bin/crt
