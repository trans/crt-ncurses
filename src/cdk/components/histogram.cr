module CDK
  class Histogram < CDK::CDKObjs
    property orient : Int32 = CDK::HORIZONTAL
    property filler : Int32 = '#'.ord | LibNCurses::Attribute::Reverse.value.to_i32
    property stats_attr : Int32 = 0
    property stats_pos : Int32 = CDK::TOP
    property view_type : CDK::HistViewType = CDK::HistViewType::REAL
    ...
    def initialize(cdkscreen : CDK::Screen, xplace : Int32, yplace : Int32,
                   height : Int32, width : Int32, orient : Int32,
                   title : String, box : Bool, shadow : Bool)
      super()
      ...
      box_height = CDK.set_widget_dimension(parent_height, height, 2)
      ...
      @stats_attr = 0
      @stats_pos = CDK::TOP
      @view_type = CDK::HistViewType::REAL
    ...
    def set(view_type : CDK::HistViewType, stats_pos : Int32, stats_attr : Int32,
    ...
    def set_value(low : Int32, high : Int32, value : Int32)
      ...
      return if @view_type == CDK::HistViewType::NONE
    ...
    def set_display_type(view_type : CDK::HistViewType)
      @view_type = view_type
    end

    def get_view_type : CDK::HistViewType
      @view_type
    end
    ...
    def draw(box : Bool)
      ...
      # Draw stat labels
      if @view_type != CDK::HistViewType::NONE
        if @low_string.size > 0
          Draw.write_char_attrib(w, @lowx, @lowy, @low_string,
            @stats_attr, @orient == CDK::VERTICAL ? CDK::VERTICAL : CDK::HORIZONTAL,
            0, @low_string.size)
        end
    ...
    private def format_value_string : String
      case @view_type
      when CDK::HistViewType::PERCENT
        "%3.1f%%" % [100.0 * @percent]
      when CDK::HistViewType::FRACTION
        "%d/%d" % [@value, @high]
      else
        @value.to_s
      end
