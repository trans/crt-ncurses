module CDK
  class Scroll < CDK::Scroller
    ...
    def initialize(cdkscreen : CDK::Screen, xplace : Int32, yplace : Int32,
      ...
      scrollbar_offset = splace == CDK::LEFT ? 1 : 0
      @list_win = CDK.subwin(w, max_view_size,
      ...
      # Set up key bindings
      bind(:SCROLL, CDK::BACKCHAR, :getc, LibNCurses::Key::PageUp.value)
      bind(:SCROLL, CDK::FORCHAR, :getc, LibNCurses::Key::PageDown.value)
    ...
    def draw_current
      ...
      Draw.write_chtype_attrib(lw,
        ...
        @current_high, @item[@current_item], hl, CDK::HORIZONTAL,
    ...
    def draw_list(box : Bool)
      ...
      if @list_size > 0
        (0...@view_size).each do |j|
          ...
          Draw.write_blanks(lw, 0, j, CDK::HORIZONTAL, 0,
    ...
    def destroy
      ...
      CDK.delete_curses_window(@list_win)
