module CRT
  class FScale < CRT::CRTObjs
    ...
    def initialize(cdkscreen : CRT::Screen, xplace : Int32, yplace : Int32,
      ...
      bind(:FSCALE, CRT::BACKCHAR, :getc, LibNCurses::Key::PageUp.value)
      bind(:FSCALE, CRT::FORCHAR, :getc, LibNCurses::Key::PageDown.value)
    ...
    def destroy
      ...
      CRT::Screen.unregister(:FSCALE, self)
    end
