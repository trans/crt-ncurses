module CRT
  class FSlider < CRT::CRTObjs
    ...
    def initialize(cdkscreen : CRT::Screen, xplace : Int32, yplace : Int32,
      ...
      bind(:FSLIDER, CRT::BACKCHAR, :getc, LibNCurses::Key::PageUp.value)
      bind(:FSLIDER, CRT::FORCHAR, :getc, LibNCurses::Key::PageDown.value)
    ...
    def destroy
      ...
      CRT::Screen.unregister(:FSLIDER, self)
    end
